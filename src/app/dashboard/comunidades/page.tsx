        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
                    <button
                        ...
                        className="border border-neutral-200 bg-white hover:bg-neutral-50 text-neutral-700 px-4 py-2 rounded-xl flex items-center gap-2 transition font-semibold text-sm shadow-sm"
                    >
            ...
            {portalReady && showForm && createPortal(
                ...
                >
                    <div
                        className="bg-white w-full max-w-2xl rounded-xl shadow-2xl flex flex-col overflow-hidden max-h-[95vh] animate-in fade-in zoom-in duration-200"
