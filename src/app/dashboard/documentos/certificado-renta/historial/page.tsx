        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-neutral-900">Historial · Certif. Renta</h1>
                        <p className="text-sm text-neutral-600 mt-1">
                            Listado de certificados generados recientemente.
                        </p>
                    </div>
                </div>
            ...
            {/* Table */}
            <ClientHistoryTable entries={entries} type="certificado-renta" />
